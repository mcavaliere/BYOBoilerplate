...
const Commands = {
  init: () => {
    ...
    console.log("  ...initializing ".concat(_constants.default.CONFIG_FILE_PATH, " with default generators..."));
    ...
    console.log("  ...initializing ".concat(_constants.default.TEMPLATE_DIR_PATH, " with default generators..."));
