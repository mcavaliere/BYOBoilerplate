...
Constants$1 = {
    ...Constants$1,
    CONFIG_FILE_PATH: `./${Constants$1.CONFIG_FILE_NAME}`,
...
// Generated by CoffeeScript 1.10.0
(function() {
  var Block, Liquid, Promise_each, extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
    hasProp = {}.hasOwnProperty;
...
var document = createCommonjsModule(function (module) {
// Generated by CoffeeScript 1.10.0
(function() {
  var Liquid,
    extend = function(child, parent) { for (var key in parent) { if (hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; },
...
const configFileAlreadyExists = `  ...config file already exists in ${Constants$2.CONFIG_FILE_PATH}. Either edit it directly, or delete it to generate from scratch. `;

const templateDirectoryAlreadyExists = `  ...template directory ${Constants$2.TEMPLATE_FILE_PATH} already exists. Either edit it directly, or delete it to generate from scratch. `;
...
class Core {
    ...
    loadConfig() {
        return JSON.parse(
            lib.readFileSync( Constants$2.CONFIG_FILE_PATH )
        );
    }
